  ...
  return (
    <Card className="flex min-h-64 flex-col p-5 transition-shadow hover:shadow-md">
      ...
      <div className="mt-5 flex-1">
        ...
        <pre className="mt-4 line-clamp-4 overflow-hidden rounded-lg bg-app p-3 text-xs leading-5 text-muted">
          <code>{snippet.code}</code>
        </pre>
      </div>
      <footer className="mt-5 flex items-center justify-between gap-3 border-t border-border pt-4">
