...
export function AuthLayout({ children, description, title }: AuthLayoutProps) {
  ...
  <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center">
    <div className="max-w-md space-y-5">
      ...
      <h1 className="text-4xl font-semibold tracking-tight text-text">A focused workspace for builders.</h1>
      <p className="text-base leading-7 text-secondary">Plan, ship, and keep your development work moving without the noise.</p>
    </div>
  </div>
  <p className="relative z-10 text-sm text-muted">Built for the flow state.</p>
</section>
