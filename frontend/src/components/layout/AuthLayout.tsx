    ...
    <main className="auth-page-shell relative isolate min-h-screen overflow-hidden bg-background lg:grid lg:grid-cols-2">
      <section className="relative hidden overflow-hidden p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="auth-illustration absolute inset-x-8 top-1/2 -translate-y-1/2">
          <svg
            aria-label="Animated developer console illustration"
          ...
          >
            <g className="auth-core">
              ...
              <rect
                ...
                y="145"
              />
              <circle className="auth-console-sm" cx="296" cy="150" r="9" />
              <rect
                className="auth-track"
                height="10"
                rx="5"
              ...
              <rect
                ...
                y="179"
              />
              <circle className="auth-console-sm" cx="258" cy="184" r="9" />
              <rect
                className="auth-track"
                height="26"
                rx="13"
                ...
                y="207"
              />
              <Search className="text-muted" size="16" x="198" y="212" />
              <rect
                fill="currentColor"
                height="6"
                opacity=".45"
                ...
                y="217"
              />
              <circle cx="332" cy="220" fill="#ef5b4e" r="2.4" />
              <circle cx="340" cy="220" fill="var(--color-primary)" r="2.4" />
              <circle cx="348" cy="220" fill="#3fcb7c" r="2.4" />
              <circle cx="356" cy="220" fill="var(--color-primary)" r="2.4" />
              <text
                fill="currentColor"
            ...
            <g className="auth-badge-left">
              <circle className="auth-console-sm" cx="144" cy="120" r="29" />
              <LockKeyhole
                ...
                y="107"
              />
              <circle cx="144" cy="75" fill="#ef5b4e" r="2.2" />
              <circle cx="178" cy="96" fill="var(--color-primary)" r="2.2" />
              <circle cx="178" cy="136" fill="#3fcb7c" r="2.2" />
              <circle cx="144" cy="157" fill="var(--color-primary)" r="2.2" />
            </g>
            <g className="auth-badge-right">
              <rect
                fill="#3fcb7c"
                height="28"
                opacity=".85"
                ...
                y="260"
              />
              <circle className="auth-console-sm" cx="430" cy="274" r="11" />
            </g>
            <g className="auth-spinner" transform="translate(415 115)">
              <path
                d="M8 0h5M2 8l2 5M-6 5l-4 3M-6-5l-4-3M2-8l2-5"
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
                strokeWidth="2"
            ...
            />
            <circle
              className="auth-particle auth-particle-delay"
              cx="338"
              cy="76"
              fill="#e38fa0"
              r="2.5"
